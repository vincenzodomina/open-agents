  ...
  public: {
    Tables: {
      ...
      chat_reads: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_reads_chat_id_chats_id_fk"
            columns: ["chat_id"]
            isOneToOne: false
            referencedRelation: "chats"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "chat_reads_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      chats: {
        ...
        Relationships: [
          {
            foreignKeyName: "chats_session_id_sessions_id_fk"
            columns: ["session_id"]
            isOneToOne: false
      ...
      github_installations: {
        ...
        Relationships: [
          {
            foreignKeyName: "github_installations_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      linked_accounts: {
        ...
        Relationships: [
          {
            foreignKeyName: "linked_accounts_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      shares: {
        ...
        Relationships: [
          {
            foreignKeyName: "shares_chat_id_chats_id_fk"
            columns: ["chat_id"]
            isOneToOne: false
            referencedRelation: "chats"
            referencedColumns: ["id"]
      ...
      usage_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "usage_events_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      vercel_project_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "vercel_project_links_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      workflow_run_steps: {
        ...
        Relationships: [
          {
            foreignKeyName: "workflow_run_steps_workflow_run_id_workflow_runs_id_fk"
      ...
      workflow_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "workflow_runs_chat_id_chats_id_fk"
            columns: ["chat_id"]
            isOneToOne: false
            referencedRelation: "chats"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "workflow_runs_session_id_sessions_id_fk"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "workflow_runs_user_id_users_id_fk"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
